...
class LaLoSecondTest {
    ...
    fun test() {
        ...
        test(SOUTH, 10,50,15, WEST, 10, 30,16, "S 10°50'15\" W 010°30'16\"")
        test(SOUTH, 10,0,0, WEST, 100,0,0, "S 10°00'00\" W 100°00'00\"")
    }

    fun test(latH: Hemisphere, latD: Int, latM: Int, latS: Int, lonH: Hemisphere, lonD: Int, lonM: Int, lonS:Int, expected: String) {
